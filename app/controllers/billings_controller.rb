...
class BillingsController < ApplicationController
  def index
    @billings = current_user.account.billings.order(id: :desc).where.not(billing_type: ["To Frost", "From Balance", "From Frost", "To Balance", "获得投标", "交易账户出金"], state: "cancelled").paginate(:page => params[:page], :per_page => 10)
  end
